...
export const ALLOCATED_GROUP_COLUMNS: ColumnDefinition[] = [
	{
		field: "clientName",
...
export const ALLOCATED_FIXED_COLUMNS: ColumnDefinition[] = [
	{
		field: "feeCode",
		headerTerm: "FeeCode",
		sortable: true,
...
export function getAllocatedConfigurableColumns(amountHeader = "Amount"): ColumnDefinition[] {
	return [
		{
			field: "typeOfRate",
