...
@Component({
	selector: "list-item-opt-out-request",
	imports: [CommonModule, Button, Card, Badge],
	templateUrl: "./list-item-opt-out-request.html",
})
export class ListItemOptOutRequest implements OnInit, OnDestroy {
	...
	get optOutRequest(): any {
		return this.domain.getJsonData(this.notification?.metaData)?.optOutRequest;
	}
